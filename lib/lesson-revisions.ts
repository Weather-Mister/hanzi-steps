...
export const previousLessonLengths:Record<string,number>={
 ...
 // Units 28–29 were rebalanced after first publication. Existing step order is
 // preserved; only new practice is appended, so these original completion bounds remain valid.
 'u28-film':5,
 'u28-years-days':14,
 'u28-hours':13,
 'u28-separable':6,
