# Lesson 14 Activity Spec — Unit 44
...
- formal NEW vocabulary: 12
- NEW characters: 7
- formal grammar: G004–G005
- support expansion: 濕濕的
- culture: B1L14-CUL001
- final Lesson-14 capstone
...
- examples:
  1. 星期天我更忙。 / Xīngqítiān wǒ gèng máng. / I am even busier on Sunday.
  2. 今年比去年更冷。 / Jīnnián bǐ qùnián gèng lěng. / This year is even colder than last year.
  3. 這次的颱風是不是比上次的更大？ / Zhè cì de táifēng shì bú shì bǐ shàng cì de gèng dà? / Is this typhoon even bigger than the last one?
...
- examples:
  1. 火車沒有高鐵那麼快。 / Huǒchē méiyǒu gāotiě nàme kuài. / The train is not as fast as the HSR.
  2. 這次的颱風沒有上次的那麼可怕。 / Zhè cì de táifēng méiyǒu shàng cì de nàme kěpà. / This typhoon is not as scary as the last one.
  3. 今天有沒有昨天熱？ / Jīntiān yǒu méiyǒu zuótiān rè? / Is today as hot as yesterday?
...
|---|---|---|
| u44-umbrella | 傘 | u44-umbrella-傘 |
| u44-typhoon | 颱 | u44-typhoon-颱 |
| u44-wet | 濕 | u44-wet-濕 |
| u44-wet | 討 | u44-wet-討 |
| u44-wet | 厭 | u44-wet-厭 |
| u44-news | 聞 | u44-news-聞 |
| u44-even-more | 更 | u44-even-more-更 |

## 5. Teaching lessons — exact assessed payloads

### u44-umbrella — Where's Your Umbrella?

Order:
1. 傘 lifecycle.
2. select `u44-umbrella-s1`
   - prompt: **傘 means…**
   - options: [`umbrella`, `rain`, `typhoon`]
   - answer: **umbrella**
...
### u44-typhoon — A Typhoon Is Coming
...
### u44-even-more — This Time Is Even Bigger
...
6. `u44-review-shi` — complete 濕
7. `u44-review-tao` — complete 討
8. `u44-review-yan` — complete 厭
9. `u44-review-wen` — complete 聞
...
| Unit-43 delayed lexical/sense targets | Unit-43 lessons/review | review-u43-1–review-u43-4 | order production | capstone retention |
| F/S001–004 | prior unit lifecycle | review-cap1–review-cap4 as Chinese order production | same | Lesson-14 closure |
...
- deferred 飛 / 故 / 宮 / 蓮 / 烏 / 龍 and proper-name glyphs do not appear in required answers.
- culture content is source-derived historical context only; no current factual claim is added.
